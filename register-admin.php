...
if(isset($_POST['create'])){
    ...
    // }
         ...
         $insertsql="INSERT INTO users(username,email,password,created_at,role) VALUES(?,?,?,NOW(),?)";
...
<title>Sign Up Admin - City Information System</title>
...
<div class="form-container">
  <h2><i class="fas fa-user-plus"></i> Sign Up-Admin</h2>
